...
URL_DOWNLOAD_DB_URL = "http://download.ip2location.com/lite/\
IP2LOCATION-LITE-DB1{IP_VERSION}.{FORMAT}.ZIP"

URL_AUTH_DOWNLOAD_DB_URL = "https://www.ip2location.com/download/"


def download_free_db_zip(
    target, IP_VERSION=IPVersionEnum.IPV4, FORMAT=FormatEnum.CSV
):
    """
    """
    download_url = URL_DOWNLOAD_DB_URL.format(
